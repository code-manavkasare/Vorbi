...
const Signup: React.FunctionComponent<StackScreenProps<StackParamList, 'Signup'>> = ({ navigation }) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{ display: 'flex', flexDirection: 'row' }}>
                <Text style={{ color: '#6D7187' }}>Don't have an account? </Text><TouchableOpacity onPress={() => { navigation.navigate('Login') }} style={{ alignItems: 'center', justifyContent: 'center', display: 'flex' }}><Text style={{ color: '#6D71A7' }}>Signup</Text></TouchableOpacity>
            </View>
        </View>
    );
};
